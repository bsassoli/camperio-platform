...
def build_cliente(pf, repo_dir, livello=1):
    ...
    # denominatore dell'allocazione = patrimonio CONSFIN (come Antana): % = esposizione / NAV
    # (fix 23/07/2026, validato su R1450). Variabile separata da `base` (= NAV di inizio anno).
    base_alloc = nav
